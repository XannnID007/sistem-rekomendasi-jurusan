                        ...
                        <div>
                            ...
                            <select name="biaya_gelombang" id="biaya_gelombang"
                                ...
                                <option value="G1. Rp 1.000.000"
                                    {{ old('biaya_gelombang', $penilaian->biaya_gelombang) === 'G1. Rp 1.000.000' ? 'selected' : '' }}>
                                    G1. Rp 1.000.000 </option>
                                <option value="G2. Rp 1.500.000"
                                    {{ old('biaya_gelombang', $penilaian->biaya_gelombang) === 'G2. Rp 1.500.000' ? 'selected' : '' }}>
                                    G2. Rp 1.500.000 </option>
                                <option value="G3. Rp 2.000.000"
                                    {{ old('biaya_gelombang', $penilaian->biaya_gelombang) === 'G3. Rp 2.000.000' ? 'selected' : '' }}>
                                    G3. Rp 2.000.000 </option>
                                <option value="G4. Rp 2.500.000"
                                    {{ old('biaya_gelombang', $penilaian->biaya_gelombang) === 'G4. Rp 2.500.000' ? 'selected' : '' }}>
