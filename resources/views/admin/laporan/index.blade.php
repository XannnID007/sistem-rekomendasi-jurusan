        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1">
                        <h3 class="font-medium text-gray-900">Laporan Individual</h3>
                        <p class="text-sm text-gray-500">Laporan per siswa</p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1">
                        <h3 class="font-medium text-gray-900">Laporan Ringkasan</h3>
                        <p class="text-sm text-gray-500">Ringkasan keseluruhan</p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1">
                        <h3 class="font-medium text-gray-900">Laporan Perbandingan</h3>
                        <p class="text-sm text-gray-500">Perbandingan antar tahun</p>
                    </div>
