        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-6">
                    ...
                    @foreach ($topPerformers as $index => $performer)
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <p class="font-medium text-gray-900">{{ $performer->pesertaDidik->nama_lengkap }}</p>
                                    <p class="text-sm text-gray-500">NISN: {{ $performer->pesertaDidik->nisn }}</p>
                                </div>
                            </div>
                            <div class="text-right">
                                <div class="flex items-center space-x-3">
                                    <span
                                        class="text-lg font-bold text-navy">{{ number_format($performer->nilai_preferensi, 4) }}</span>
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $performer->jurusan_rekomendasi === 'TKJ' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800' }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                ...
                                                <div class="text-sm text-gray-500">NISN: {{ $rec->pesertaDidik->nisn }}
                                                </div>
                                            </div>
                                        </div>
                                    </td>
            ...
            @if ($rekomendasi->count() > 0)
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <p class="text-sm text-gray-500 mt-3">Export akan mengikuti filter yang sedang aktif</p>
                </div>
            @endif
        </div>
