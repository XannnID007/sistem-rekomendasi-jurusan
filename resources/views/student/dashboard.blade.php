        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <a href="{{ route('student.rekomendasi.index') }}"
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Lihat rekomendasi jurusan</p>
                    </div>
                </div>
            </a>
            ...
            <a href="{{ route('student.analisis.index') }}"
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h3 class="font-medium text-gray-900">Detail Analisis</h3>
                        <p class="text-sm text-gray-500">Analisis TOPSIS lengkap</p>
                    </div>
                </div>
            </a>
            ...
            <a href="{{ route('student.profil.index') }}"
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h3 class="font-medium text-gray-900">Profil Saya</h3>
                        <p class="text-sm text-gray-500">Kelola profil dan akun</p>
                    </div>
                </div>
            </a>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Panduan penggunaan sistem</p>
                    </div>
                </div>
            </div>
        </div>
